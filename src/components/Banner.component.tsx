...
export default function Banner() {
  return (
    <div className="">
      <Navigation />
      <div className="h-full banner-image w-screen px-7 lg:px-28 max-w-[1440px] h-[984px] mx-auto relative w-full overflow-hidden isolate">
        {/* <img src={BannerImage} className="absolute w-screen h-screen" /> */}
        <div className="grid grid-cols-2 gap-4 h-full">
          <div className="my-auto">
            <h1 className="font-bold text-[68.94px] text-white leading-[76.24px] uppercase">
              Let your <br />
              mind <span className="banner-gradient-text">explore</span> <br />
              new world
            </h1>
            <p className="text-[18.72px] text-white leading-[34.64px] font-normal mt-5 mb-12">
            ...
            <div className="grid grid-cols-4 gap-2 mt-16 ml-[-2rem]">
              <div className="text-center">
                <p className="text-[30px] font-extrabold text-white mb-2">
                  300+
                </p>
                <p className="text-[18.72px] text-white">Unique Style</p>
              </div>
              <div className="text-center">
                <p className="text-[30px] font-extrabold banner-gradient-text mb-2">
                  200+
                </p>
                <p className="text-[18.72px] text-white">Project finished</p>
              </div>
              <div className="text-center">
                <p className="text-[30px] font-extrabold text-white mb-2">
                  500+
                </p>
                <p className="text-[18.72px] text-white">Happy Customer</p>
              </div>
            </div>
          </div>
        </div>
        ...
        border-y-2 border-[#d9d9d940] ml-[-7rem] rotate-[-1.30deg]"
        >
